module Swagger
  module Blocks
    module Nodes
      # v2.0: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/2.0.md#path-item-object
      # v3.0.0: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.0.md#path-item-object
      class PathNode < Node
        OPERATION_TYPES = [:get, :put, :post, :delete, :options, :head, :patch, :trace].freeze
